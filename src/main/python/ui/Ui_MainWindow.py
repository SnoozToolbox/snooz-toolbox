...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.content_tabWidget.setTabPosition(QTabWidget.North)
        self.content_tabWidget.setTabShape(QTabWidget.Rounded)
        self.content_tabWidget.setElideMode(Qt.ElideNone)
        ...
        self.menuBar.setGeometry(QRect(0, 0, 819, 24))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionAbout_Snooz.setText(QCoreApplication.translate("MainWindow", u"About Snooz", None))
