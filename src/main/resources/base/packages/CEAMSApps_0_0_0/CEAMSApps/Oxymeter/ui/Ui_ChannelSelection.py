...
################################################################################
## Form generated from reading UI file 'Ui_ChannelSelection.ui'
##
...
class Ui_ChannelSelection(object):
    ...
    def retranslateUi(self, ChannelSelection):
        ...
        self.label.setText(QCoreApplication.translate("ChannelSelection", u"Please select the oxymeter channel", None))
