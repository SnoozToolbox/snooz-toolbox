...
#if QT_CONFIG(tooltip)
        self.csv_reports_checkbox.setToolTip(QCoreApplication.translate("TemporalLinkStep", u"CSV reports are generated by default (values are easily exportable).", None))
#endif // QT_CONFIG(tooltip)
        self.csv_reports_checkbox.setText(QCoreApplication.translate("TemporalLinkStep", u"CSV reports", None))
    # retranslateUi
