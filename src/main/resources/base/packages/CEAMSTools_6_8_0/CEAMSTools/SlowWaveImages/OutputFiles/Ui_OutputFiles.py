...
class Ui_OutputFiles(object):
    def setupUi(self, OutputFiles):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 882, 1035))
        sizePolicy1 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Maximum)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(1)
        sizePolicy1.setHeightForWidth(self.scrollAreaWidgetContents.sizePolicy().hasHeightForWidth())
        self.scrollAreaWidgetContents.setSizePolicy(sizePolicy1)
        self.scrollAreaWidgetContents.setMinimumSize(QSize(862, 1000))
        ...
        self.horizontalSpacer_5 = QSpacerItem(130, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)
        ...
        self.label_7.setMinimumSize(QSize(0, 180))
        ...
        self.lineEdit_output.setMinimumSize(QSize(600, 0))
...
"Each SW curve represents the signal averaged accross all the selected channels or ROIs for a group of subjects.", None))
...
"Each SW curve represents the signal for a selected channel or ROI for a group of subjects.", None))
        ...
        self.checkBox_category.setText(QCoreApplication.translate("OutputFiles", u"Differentiate slow wave categories: use pattern/color to distinguish slow waves with different transition frequency (if the information is available).", None))
        ...
        self.radioButton_meanstd.setText(QCoreApplication.translate("OutputFiles", u"MEAN + STD : Display the mean SW curve in bold line and the SW curve standard deviation in gray shaded area.", None))
