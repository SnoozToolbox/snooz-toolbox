...
class Ui_PSGReaderSettingsView(object):
    def setupUi(self, PSGReaderSettingsView):
        ...
        PSGReaderSettingsView.resize(1006, 570)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 333, 220))
        ...
        self.horizontalSpacer = QSpacerItem(13, 21, QSizePolicy.Expanding, QSizePolicy.Minimum)
