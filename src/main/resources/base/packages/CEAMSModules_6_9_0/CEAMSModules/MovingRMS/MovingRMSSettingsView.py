...
"""
    Settings viewer of the MovingRMS plugin
"""

from qtpy import QtWidgets

from CEAMSModules.MovingRMS.Ui_MovingRMSSettingsView import Ui_MovingRMSSettingsView
from commons.BaseSettingsView import BaseSettingsView

class MovingRMSSettingsView( BaseSettingsView,  Ui_MovingRMSSettingsView, QtWidgets.QWidget):
    """
        MovingRMSView set the MovingRMS settings
    """
    ...
    def on_apply_settings(self):
        ...
        """
        # Send the settings to the publisher for inputs to MovingRMS
