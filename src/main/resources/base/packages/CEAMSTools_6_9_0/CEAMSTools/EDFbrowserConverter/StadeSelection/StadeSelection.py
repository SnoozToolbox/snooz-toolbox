...
from CEAMSTools.EDFbrowserConverter.Commons import ContextConstants # Import the keys for the context
from CEAMSTools.EDFbrowserConverter.StadeSelection.Ui_StadeSelection import Ui_StadeSelection # UI
from CEAMSTools.EDFbrowserConverter.Commons.EventsProxyModel import EventsProxyModel # To filter events on the UI
