...
from CEAMSTools.ArtifactDetection.BslVarStep.Ui_BslVarStep import Ui_BslVarStep
from CEAMSTools.ArtifactDetection.DetectorsStep.DetectorsStep import DetectorsStep
...
class BslVarStep( BaseStepView,  Ui_BslVarStep, QtWidgets.QWidget):
    ...
    def __init__(self, **kwargs):
        ...
        # Node identifier taken from resources/presets/ArtifactDetection_PowerLine/ArtifactDetection_PowerLine.json
