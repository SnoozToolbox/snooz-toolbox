...
See the file LICENCE for full license details.
    ...
    Settings viewer of the DpliConnectivity plugin
"""

from qtpy import QtWidgets

from CEAMSModules.DpliConnectivity.Ui_DpliConnectivitySettingsView import Ui_DpliConnectivitySettingsView
from commons.BaseSettingsView import BaseSettingsView

class DpliConnectivitySettingsView(BaseSettingsView, Ui_DpliConnectivitySettingsView, QtWidgets.QWidget):
    """
        DpliConnectivityView set the DpliConnectivity settings
    """
    ...
    def on_apply_settings(self):
        ...
        # Send the settings to the publisher for inputs to DpliConnectivity
