...
See the file LICENCE for full license details.
    ...
    Settings viewer of the ConnectivityDetails plugin
"""

from qtpy import QtWidgets

from CEAMSModules.ConnectivityDetails.Ui_ConnectivityDetailsSettingsView import Ui_ConnectivityDetailsSettingsView
from commons.BaseSettingsView import BaseSettingsView

class ConnectivityDetailsSettingsView(BaseSettingsView, Ui_ConnectivityDetailsSettingsView, QtWidgets.QWidget):
    """
        ConnectivityDetailsView set the ConnectivityDetails settings
    """
    ...
    def on_apply_settings(self):
        ...
        """
        # Send the settings to the publisher for inputs to ConnectivityDetails
