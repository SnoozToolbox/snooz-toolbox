...
See the file LICENCE for full license details.
    ...
    Settings viewer of the RemoveChannelArtefact plugin
"""

from qtpy import QtWidgets

from CEAMSModules.RemoveChannelArtefact.Ui_RemoveChannelArtefactSettingsView import Ui_RemoveChannelArtefactSettingsView
from commons.BaseSettingsView import BaseSettingsView

class RemoveChannelArtefactSettingsView(BaseSettingsView, Ui_RemoveChannelArtefactSettingsView, QtWidgets.QWidget):
    """
        RemoveChannelArtefactView set the RemoveChannelArtefact settings
    """
    ...
    def on_apply_settings(self):
        ...
        """
        # Send the settings to the publisher for inputs to RemoveChannelArtefact
