...
class AnalyzeEEGConnectivityDoc(BaseStepView, Ui_AnalyzeEEGConnectivityDoc, QtWidgets.QWidget):
    """
        AnalyzeEEGConnectivityDoc
    ...
    def __init__(self, **kwargs):
        ...
        #self._context_manager["context_AnalyzeEEGConnectivityDoc"] = {"the_data_I_want_to_share":"some_data"}
