...
class SlowWaveClassifier(SciNode):
    ...
    def compute(self, sw_char_files, sw_cohort_file, sw_stages_files, automatic_classification, num_categories, num_divisions, output_dir):
        """
        ...
        out_columns = list(_get_doc(self.N_CYCLE, num_divisions, n_dist).keys())
        ...
        try : 
            ...
            if not os.path.exists(doc_filepath):
                write_doc_file(doc_filepath, self.N_CYCLE, num_divisions, n_dist)
