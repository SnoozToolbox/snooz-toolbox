...
class PSACompilation(SciNode):
    ...
    def __init__(self, **kwargs):
        ...
        # Define the number of hours to analysed (after 9, the 10 will be placed first)
        self.N_HOURS = 12
        self.N_CYCLES = 8
    ...
    def compute(self, subject_info, PSD, sleep_stages, events, mini_bandwidth, first_freq, last_freq, dist_total, \
        dist_hour, dist_cycle, parameters_cycle, artefact_group, artefact_name, cycle_labelled, filename):
        """
        Inputs:
            "subject_info": dict
                filename : Recording filename without path and extension.
