...
DEBUG = False
N_CYCLES_STATS = 10 # Number of cycles included in the stats
...
class EventSleepReport(SciNode):
    ...
    def compute(self, events, record_info, sleep_stages, events_report_criteria, nominal_values, \
        html_report, html_report_config, csv_report, save_events_report, output_prefix, output_directory):
        """
        TODO DESCRIPTION
        ...
        for report in events_report_criteria:
            ...
            stats_cycles, stats_info_cycle = self.compute_evt_stats_cycle(\
                N_CYCLES_STATS, filtered_events, sleep_stages, report)
