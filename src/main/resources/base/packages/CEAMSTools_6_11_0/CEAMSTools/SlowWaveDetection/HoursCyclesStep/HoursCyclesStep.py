...
from CEAMSTools.SlowWaveDetection.HoursCyclesStep.Ui_HoursCyclesStep import Ui_HoursCyclesStep
...
class HoursCyclesStep(BaseStepView, Ui_HoursCyclesStep, QtWidgets.QWidget):
    ...
    def __init__(self, **kwargs):
        ...
        self._SWDetails_id = "0308c274-4216-4642-9093-0ac919e9a0de"
        self._constants_report_topic = self._SWDetails_id + ".report_constants" 
